...
def breakout_plot_factory_v2(root='/home/allenchen/Moana_proj/neural_skill_search/log/other/20M_top3_life/Breakout/dqn/a2c',
                           trace_groups=['ori', 'ev', 'top3'],
                           colors=['green', 'blue', 'red'],
                           legends=['Primitive', 'Evolution', 'Ours'],
                           title='Breakout',
                           filename='outputs/Breakout/v2/breakout_plot.png',
                           max_steps=10000000,
                           scale=4,
                           **kwargs):
    '''
    ...
    template['subplots']['layout']['yaxis']['dtick'] = 80
