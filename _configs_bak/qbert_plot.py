...
def qbert_plot_factory(root='/home/allenchen/Moana_proj/neural_skill_search/log/other/final_20M_top3/Qbert',
                           trace_groups=['ori', 'ev', 'dqn/top3'],
                           colors=['green', 'blue', 'red'],
                           legends=['Primitive', 'Evolution', 'Ours'],
                           title='Qbert',
                           filename='outputs/Qbert/qbert_plot.png',
                           scale=4):
    ...
    template['subplots']['layout']['yaxis']['dtick'] = 2000
...
def qbert_plot_factory_v2(root='/home/allenchen/Moana_proj/neural_skill_search/log/other/20M_top3_life/Qbert/dqn/a2c',
