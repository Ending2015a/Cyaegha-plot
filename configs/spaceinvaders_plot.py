...
def spaceinvaders_plot_factory(root='/home/allenchen/Moana_proj/neural_skill_search/log/other/20M_top3/SpaceInvaders',
                               trace_groups=['ori', 'ev', 'dqn/top1'],
                               colors=['green', 'blue', 'red'],
                               legends=['Primitive', 'Evolution', 'Ours'],
                               title='Space Invaders',
                               filename='outputs/space_invaders/spaceinvaders_plot.png',
                               scale=4):
...
def spaceinvaders_plot_factory_v2(root='/home/allenchen/Moana_proj/neural_skill_search/log/other/20M_top3_life/Qbert/dqn/a2c',
