...
def beamrider_plot_factory(root='/home/allenchen/Moana_proj/neural_skill_search/log/other/final_20M_top3/BeamRider/dqn',
                           trace_groups=['primitive', 'ev', 'macro'],
                           colors=['green', 'blue', 'red'],
                           legends=['Primitive', 'Evolution', 'Ours'],
                           title='Beamrider',
                           filename='outputs/beamrider/beamrider_plot.png',
                           scale=4,
                           **kwargs):
...
def beamrider_plot_factory_v2(root='/home/allenchen/Moana_proj/neural_skill_search/log/other/final_20M_top3_life/BeamRider/dqn/a2c',
                           trace_groups=['ori', 'ev', 'top3'],
                           colors=['green', 'blue', 'red'],
                           legends=['Primitive', 'Evolution', 'Ours'],
                           title='Beamrider',
                           filename='outputs/Beamrider/v2/beamrider_plot.png',
                           max_steps=10000000,
                           scale=4,
                           **kwargs):
    '''
    ...
    for idx, group in enumerate(trace_groups):
        ...
        if 'dash' in kwargs:
            ...
            if not isinstance(dash, (tuple, list)):
                line['dash'] = dash
            else:
                line['dash'] = dash[idx]
