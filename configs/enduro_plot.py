...
def enduro_plot_factory(root='/home/allenchen/Moana_proj/neural_skill_search/log/other/final_20M_top3/Enduro',
                           trace_groups=['ori', 'ev', 'dqn/top3'],
                           colors=['green', 'blue', 'red'],
                           legends=['Primitive', 'Evolution', 'Ours'],
                           title='Enduro',
                           filename='outputs/Enduro/enduro_plot.png',
                           scale=4):
    ...
    template['subplots']['layout']['yaxis']['dtick'] = 200
...
def enduro_plot_factory_v2(root='/home/allenchen/Moana_proj/neural_skill_search/log/other/20M_top3_life/Seaquest/dqn/a2c',
                           trace_groups=['ori', 'ev', 'top3'],
                           colors=['green', 'blue', 'red'],
                           legends=['Primitive', 'Evolution', 'Ours'],
                           title='Enduro',
                           filename='outputs/Enduro/v2/enduro_plot.png',
                           max_steps=10000000,
                           scale=4,
                           **kwargs):
    '''
